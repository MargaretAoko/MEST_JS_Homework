...
var var = 'variable';//The variable tag var has been assigned twice making the code invalid. It should be only one. var = 'Variable';
var first name = 'Jerry';//JavaScript uses camelCase for identifying names of variables and functions. Var firstName = 'Jerry';
var Sch00lName = 'MEST';//The variable name Sch00LName has digit '0' instade of letter 'o' then it's invalid because it's not camelCase it starts with caps 'S'. var schoolName = 'Jerry';
var totalnumber = 100;//variable name is not camelCase. var totalNumber = 100;
